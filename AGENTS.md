...
**Protocolo de Ação:** Antes de entregar qualquer código ou plano, valide mentalmente: _"Minha solução quebra o SOLID, duplica código ou mistura regras de negócio com infraestrutura?"_. Se sim, corrija-a antes de responder.
